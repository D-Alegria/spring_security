...
public class JwtTokenVerifier extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            String secretKey = "securetestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecuresecuretestsecure";
